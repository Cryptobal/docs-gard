...
export default async function HubPage() {
  ...
  const financeMetrics = hasFinance
    ? await getFinanceMetrics(tenantId)
    : null;
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <p className="mt-2 text-2xl font-semibold">{financeMetrics.pendingApprovalCount}</p>
                    <p className="mt-1 text-xs text-muted-foreground">
                  ...
                  >
                    ...
                    <p className="mt-2 text-2xl font-semibold">{financeMetrics.approvedUnpaidCount}</p>
                    <p className="mt-1 text-xs text-muted-foreground">
...
async function getFinanceMetrics(tenantId: string) {
  ...
  return {
    ...
    pendingApprovalAmount: pendingApproval.reduce((sum, r) => sum + r.amount, 0),
